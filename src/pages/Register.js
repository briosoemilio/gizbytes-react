...
const Register = () => {
	...
	useEffect(() => {
		if((email !== '') && (password1 !== '') && (password2 !== '') && (firstName !== '') && (lastName !== '') && (mobileNumber !== '') && (password1 === password2) && (mobileNumber.length == 15)){
			setIsActive(true)
		} else {
			setIsActive(false)
		}
				...
				<RegisterCard>
					<Container>
						...
						<Row style={{marginBottom: "10px", marginTop: "10px"}}>
							<Col sm={12}>Already have an account? Click <a href="/login">here</a> to Login</Col>
						</Row>					
					</Container>
				</RegisterCard>
			</ContainerMain>
