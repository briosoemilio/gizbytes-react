			...
			<ContainerMain>
				<ContainerTop>
					<FloatingLabel controlId="floatingSelectGrid" label="Sort Users">
					      <Form.Select 
					      	onChange ={e => agregateUsers(e.target.value)}>
					...
					<Form className="d-flex">
						<Form.Select className="mx-3" onChange ={e => setSearchParam(e.target.value)}>
					    ...
					    <Button variant="outline-success" type="submit" onClick={e=> searchUsers(e)}>
					       	Search
					    </Button>
					</Form>
				</ContainerTop>
